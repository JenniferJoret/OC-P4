    ...
    var e = [],
        t = {
                    ...
                    return (
                        ...
                        this.each(function () {
                            var t = a(this),
                                ...
                                d = [];
                            if ((!l.length && r.options.autoAdd && r.options.autoAdd.helpBlocks && ((l = a('<div class="help-block" />')), o.append(l), e.push(l[0])), r.options.sniffHtml)) {
                                var c = "";
                                if (
                                ...
                                if (void 0 !== t.attr("min") || void 0 !== t.attr("aria-valuemin")) {
                                    ...
                                    (c = "Too low: Minimum of '" + m + "'\x3c!-- data-validation-min-message to override --\x3e"),
                                ...
                                void 0 !== t.attr("maxlength") &&
                                    ...
                                    void 0 !== t.attr("type") &&
                                        ...
                                        ((c = "Adresse mail non valide\x3c!-- data-validator-validemail-message to override --\x3e"),
            ...
            builtInValidators: {
                ...
                required: { name: "Required", type: "required", message: "Veuillez renseigner ces informations\x3c!-- data-validator-required-message to override --\x3e" },
